                        ...
                        <div style="padding: 0 16px 16px 16px;">
                            ...
                            <div style="padding: 12px; background: ${presetBoxBackground}; border-radius: 6px; border-left: 3px solid ${toggleAccentColor};">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                    ...
                                    <div style="display:flex; align-items:center; gap:8px;">
                                        <span id="subtitlePositionReadout" style="font-size:11px; color:rgba(255,255,255,0.5); font-variant-numeric:tabular-nums;">${JE.currentSettings.subtitleHorizontalPosition ?? 50}, ${JE.currentSettings.subtitleVerticalPosition ?? 85}</span>
