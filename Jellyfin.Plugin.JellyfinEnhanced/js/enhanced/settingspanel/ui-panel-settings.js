...
(function(JE) {
    ...
    internal.wireSettingsListeners = function(ctx) {
        ...
        const updatePositionReadout = () => {
            if (posReadout) posReadout.textContent = `${JE.currentSettings.subtitleHorizontalPosition ?? 50}, ${JE.currentSettings.subtitleVerticalPosition ?? 85} · ${JE.currentSettings.subtitleLetterSpacingPct ?? 0}%`;
        };
